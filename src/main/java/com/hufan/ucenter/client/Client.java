...
public class Client extends PHPFunctions {
	...
	static {
		InputStream in = Client.class.getClassLoader().getResourceAsStream("discuz.properties");
	...
	public String uc_user_register(String $username, String $password, String $email, String $questionid,
			String $answer, String $mobile) {
		Map<String, Object> args = new HashMap<String, Object>();
		args.put("username", $username);
		args.put("password", $password);
		args.put("email", $email);
