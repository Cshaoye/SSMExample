 ...
 * 可以根据业务需要添加相应的执行代码
 * @修改 宗潇帅
 * @修改日期 2014-6-19下午5:03:37
 * @开源中国  http://my.oschina.net/xshuai/blog
 * 作者：梁平
 * 创建时间：2009-2-20
 */
public class UC extends HttpServlet{
	...
	public static String UC_CLIENT_RELEASE="20110501";//UCenter 程序版本
	...
	private String doAnswer(HttpServletRequest request, HttpServletResponse response){
		System.out.println("***************************discuz sychronaziede code to java web project************************");
		//处理
		...
		System.out.println("***********current operation is : ***********" + $get.get("action"));
